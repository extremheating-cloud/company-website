...
/about · /contact · /financing-options · /specials, emitted to "Other pages/"
...
CONTACT = {
    ...
    "hours": [
        ...
        {"label": "Monday – Friday", "value": "<!-- TODO: confirm times -->Office hours — confirm times"},
        {"label": "Saturday – Sunday", "value": "Emergency service"},
        {"label": "Emergencies", "value": "24/7 — every day of the year", "em": True},
    ],
    "rail": {
...
ABOUT = {
    ...
    "team": [{"name": "Name here", "role": "Role / years with team"}] * 4,
...
def about_page(d, root_class):
  ...
  <div class="grid">{stats}</div>
    ...
    team = "".join(
        f'''<div><div class="xco-slot slot" data-photo-slot>TECH HEADSHOT</div>
...
# ------------------------------------------------------------ registry
def pages(root):
    other = os.path.join(root, "Other pages")
    return [
